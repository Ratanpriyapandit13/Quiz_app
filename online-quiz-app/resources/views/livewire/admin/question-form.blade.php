<div class="col-12 col-md-10">
    ...
    <div class="p-6 bg-white shadow rounded" >
        <h4 class="text-lg font-semibold mb-4 ms-2">Create a New Question</h4>
        ...
        <form wire:submit.prevent="save" class="ms-2">
            <!-- Question Input -->
            <div class="mb-4">
            ...
            <!-- Submit Button -->
            <button type="submit" class="bg-blue-600 px-4 py-2 rounded mt-4">Create Question</button>
        </form>
    </div>
